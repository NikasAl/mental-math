...
│   └── requirements.txt
├── cli/                    # CLI клиент для тестирования
│   ├── mm_run.py          # Точка входа
│   ├── mm_api.py          # API клиент
│   ├── mm_screens.py      # Экраны приложения
│   ├── mm_context.py      # Контекст и утилиты
│   └── requirements.txt
...
Удобный терминальный клиент для тестирования сервера:
...
### Возможности CLI:
- 🔐 Автоматическая авторизация по account_key
- 🎯 Тренировка на текущем уровне
- 📈 Выбор уровня и темы
- ⏱️ Таймер решения
- 💡 Подсказки (пошаговое решение)
